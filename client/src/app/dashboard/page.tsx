...
export default function Dashboard() {
  ...
  return (
    <main ref={containerRef} className="min-h-screen relative overflow-y-auto overflow-x-hidden bg-black text-white flex flex-col items-center justify-center py-6 px-6">
      ...
      <Link 
        href="/profile"
        className="fixed top-8 right-8 p-4 rounded-full bg-white/5 hover:bg-purple-900/20 border border-white/10 hover:border-purple-500/30 transition-all duration-300 group backdrop-blur-md z-50 cursor-pointer"
      >
        <User className="w-6 h-6 text-white/30 group-hover:text-purple-400" />
      </Link>
      ...
      {!hasEntryToday ? (
        ...
        <div className="history-container w-full max-w-3xl z-10 flex flex-col items-center pb-12 overflow-hidden p-2">
            ...
            <div className="w-full bg-white/5 border border-white/10 backdrop-blur-xl rounded-[2rem] p-6 shadow-2xl">
                <div className="flex justify-between items-center mb-4 px-2">
                    ...
                    <div className="flex gap-2">
                        <button onClick={prevMonth} className="p-2 hover:bg-white/10 rounded-full transition-colors border border-white/5"><ChevronLeft className="w-5 h-5 text-white/70"/></button>
                        <button onClick={nextMonth} className="p-2 hover:bg-white/10 rounded-full transition-colors border border-white/5"><ChevronRight className="w-5 h-5 text-white/70"/></button>
                    </div>
                </div>
