...
import { 
  ArrowLeft, User, Calendar, ShieldAlert, CheckCircle2, AlertTriangle, Trash2, Loader2
} from "lucide-react";
        ...
        {activeTab === "profile" && (
          <form onSubmit={handleUpdateProfile} className="space-y-6">
            <div className="form-group space-y-2">
              <label className="text-xs text-white/50 uppercase tracking-wider">Email (Read Only)</label>
            ...
            <div className="pt-4 flex justify-end">
              <button type="submit" disabled={isSaving} className="btn-primary w-auto px-8 py-3 text-sm flex items-center gap-2">
          ...
          <div className="space-y-8">
            <form onSubmit={handleChangePassword} className="space-y-6">
              ...
              <div className="flex justify-end">
                <button type="submit" disabled={isSaving} className="bg-white/10 hover:bg-white/20 text-white px-6 py-2 rounded-lg text-sm font-medium transition-colors border border-white/10 flex items-center gap-2">
                  {isSaving && <Loader2 className="w-4 h-4 animate-spin" />}
                  Update Password
                </button>
              </div>
